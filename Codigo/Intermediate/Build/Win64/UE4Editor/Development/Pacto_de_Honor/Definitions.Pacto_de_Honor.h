...
#define ORIGINAL_FILE_NAME "UE4Editor-Pacto_de_Honor.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Pacto_de_Honor
#define DEPRECATED_FORGAME DEPRECATED
#define PACTO_DE_HONOR_API DLLEXPORT
